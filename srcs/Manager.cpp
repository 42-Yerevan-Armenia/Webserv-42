...
/*   Updated: 2023/11/04 18:43:00 by arakhurs         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    Manager::svrsetup(std::vector<Config> servers)
{
    ...
    {
        serverDub = false;
        for (std::vector<Config>::iterator it2 = _servers.begin(); it2 != it; ++it2)
        {
...
void    Manager::closeConnection(const int i)
{
...
void    Manager::sendResponse(const int &i, Client &c)
{
    int bytes_sent;
...
void    Manager::assignServer(Client &c)
{
    for (std::vector<Config>::iterator it = _servers.begin();
        it != _servers.end(); ++it)
    {
...
void    Manager::readRequest(const int &i, Client &c)
{
...
void    Manager::handleReqBody(Client &c)
{
...
void    Manager::sendCgiBody(Client &c, CgiHandler &cgi)
{
    int bytes_sent;
...
void    Manager::readCgiResponse(Client &c, CgiHandler &cgi)
{
